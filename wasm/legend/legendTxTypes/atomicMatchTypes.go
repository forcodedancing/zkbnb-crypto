...
func (txInfo *AtomicMatchTxInfo) VerifySignature(pubKey string) error {
	...
	inner, err := abiEncoder.Pack("", messageTypeBytes32, txInfo.SellOffer.AccountIndex, txInfo.SellOffer.NftIndex, txInfo.SellOffer.OfferId, txInfo.SellOffer.Type, txInfo.SellOffer.AssetId,
		txInfo.SellOffer.AssetAmount, txInfo.SellOffer.ListedAt, txInfo.SellOffer.ExpiredAt, txInfo.SellOffer.TreasuryRate, txInfo.SellOffer.Sig[:32], txInfo.SellOffer.Sig[32:64],
		...
		txInfo.BuyOffer.AssetAmount, txInfo.BuyOffer.ListedAt, txInfo.BuyOffer.ExpiredAt, txInfo.BuyOffer.TreasuryRate, txInfo.BuyOffer.Sig[:32], txInfo.BuyOffer.Sig[32:64], txInfo.Nonce, ChainId)
	if err != nil {
		return err
	}
